...
import com.dend.project.customer.dao.CustomerCommentDao;
import com.dend.project.customer.dao.CustomerDao;
import com.dend.project.customer.dto.CustomerCommentDto;
import com.dend.project.customer.dto.CustomerDto;
import com.dend.project.users.dao.UsersDao;
...
public class CustomerServiceImpl implements CustomerService{
	...
	public void getList(HttpServletRequest request) {
		...
		List<CustomerDto> list=cafeDao.getList(dto);
	...
	public void getDetail(HttpServletRequest request) {
		...
		//CustomerDto 에 글번호도 담기
		dto.setNum(num);
		
		//조회수 1 증가 시키기
		cafeDao.addViewCount(num);
		//글정보를 얻어와서
		CustomerDto dto2=cafeDao.getData(dto);
		
		//댓글 목록 얻어오기
		List<CustomerCommentDto> commentList=
				customerCommentDao.getList(num);
	...
	public void saveComment(HttpServletRequest request) {
		...
		int seq = customerCommentDao.getSequence();
		//댓글 정보를 Dto 에 담기
		...
		//댓글 정보를 DB 에 저장한다.
		customerCommentDao.insert(dto);		
	}

	@Override
	public void updateComment(CustomerCommentDto dto) {
		//댓글 내용 수정 반영하기 
		customerCommentDao.update(dto);
	}

	@Override
	public void deleteComment(int num) {
		//댓글 삭제 
		customerCommentDao.delete(num);
	}
	...
	public void getUpdateData(ModelAndView mView, int num) {
		...
		CustomerDto dto=cafeDao.getData(num);
